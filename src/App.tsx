...
import { ImpoundedReportTable } from "./common/crudTables/impoundedReportTable";
          ...
          element={
            <DefaultLayout>
              <Routes>
                ...
                <Route
                  path="/impoundedReportTrackingFormTable"
                  element={<ImpoundedReportTable />}
                />
                ...
                <Route
                  path="/forms/lostAndFoundTracking/:id"
                  element={<LostAndFoundTracking />}
                />
